      ...
      {!callDetail ? (
        ...
        >
          <div className="flex flex-col gap-2.5">
            ...
            <Textarea
              className="border-none bg-gray-900 text-white placeholder-gray-400 focus-visible:ring-0 focus-visible:ring-offset-0"
              onChange={(e) =>
          ...
          <div className="flex w-full flex-col gap-2.5">
            ...
            <ReactDatePicker
              ...
              className="w-full rounded bg-gray-900 text-white p-2 focus:outline-none"
            />
          </div>
        </MeetingModal>
      ) : (
